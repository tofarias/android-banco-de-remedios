        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if( dataSnapshot.exists() ){
                    ...
                    textViewCreatedAt.setText( DataHelper.createdAtToBr( necessidade.getCreatedAt()) );
                    try {
                        textViewAguardando.setText( DataHelper.calcularPeriodoAguardandoDonativo( necessidade.getCreatedAt() ) );
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if( dataSnapshot.exists() ){
                    ...
                    if( necessidade.getImgUrl() == null ){
                        ...
                        StorageReference imagemReference = mStorageReference.child("imagens").child(necessidade.getImgUrl());
